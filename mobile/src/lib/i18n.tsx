...
const DICO: Record<string, Entree> = {
  ...
  'p3.pays_autre': { fr: 'Autres (hors CEMAC)', en: 'Other (outside CEMAC)' },
  'p3.pays_origine_autre': { fr: 'Nom du pays d’origine', en: 'Country of origin name' },
  'p3.pays_destination_autre': { fr: 'Nom du pays de destination', en: 'Country of destination name' },
  'p3.province_origine': { fr: 'Province / région d’origine', en: 'Province / region of origin' },
  'champ.choisir': { fr: 'Choisir…', en: 'Choose…' },
  'champ.revenir_a_la_liste': { fr: 'Revenir à la liste', en: 'Back to list' },
  'champ.saisir_manuellement': { fr: 'Nom de la localité', en: 'Locality name' },
