...
async def test_agreger_par_pays_et_annee_inclut_passeports_et_controles(
    ...
    # Le passeport reste PRECHARGE ici (jamais imprimé) -> exclu de
    # passeports_par_statut (voir agreger_par_pays_et_annee, qui exclut
    # explicitement PRECHARGE de cette agrégation), donc rien à compter ici.
    assert sum(ligne["passeports_par_statut"].values()) == 0
