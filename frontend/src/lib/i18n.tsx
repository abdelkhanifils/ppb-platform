...
const DICO: Record<string, Entree> = {
  ...
  "impression.nb_precharges": { fr: "{n} préchargé(s)", en: "{n} preloaded" },
  "impression.nb_vierges": { fr: "{n} vierge(s)", en: "{n} blank" },
  "impression.telecharger": { fr: "Télécharger le document PDF ({n} passeport{s})", en: "Download PDF document ({n} passport{s})" },
  "impression.confirmer": { fr: "Confirmer l'impression", en: "Confirm printing" },
  "impression.seul_super_admin": { fr: "Seul un Super Admin peut confirmer l'impression centralisée.", en: "Only a Super Admin can confirm centralized printing." },
