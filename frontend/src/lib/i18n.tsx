...
const DICO: Record<string, Entree> = {
  ...
  "controle.aucun_passeport_numero": { fr: "Ce numéro ne correspond à aucun passeport connu localement. Vérifiez la saisie, ou synchronisez si vous êtes en ligne.", en: "This number doesn't match any passport known locally. Check what you typed, or sync if you're online.", es: "Este número no corresponde a ningún pasaporte conocido localmente. Verifique lo escrito, o sincronice si está en línea.", ar: "لا يتوافق هذا الرقم مع أي جواز سفر معروف محليًا. تحقق من الإدخال، أو قم بالمزامنة إذا كنت متصلًا." },
  "controle.qr_illisible": { fr: "QR illisible ? Saisir le numéro du passeport", en: "Can't read the QR? Enter the passport number", es: "¿No se puede leer el QR? Ingresar el número de pasaporte", ar: "رمز الاستجابة غير قابل للقراءة؟ أدخل رقم جواز السفر" },
  "controle.numero_placeholder": { fr: "Ex. 06-2026-0000042", en: "E.g. 06-2026-0000042", es: "Ej. 06-2026-0000042", ar: "مثال: 06-2026-0000042" },
  "controle.valider_numero": { fr: "Valider", en: "Confirm", es: "Confirmar", ar: "تأكيد" },
  ...
  "controle.signalement_titre": { fr: "Signaler une irrégularité (facultatif)", en: "Report an irregularity (optional)", es: "Señalar una irregularidad (opcional)", ar: "الإبلاغ عن مخالفة (اختياري)" },
  "controle.signalement_aide": { fr: "N'empêche jamais l'enregistrement de ce contrôle — sert uniquement à alerter sur une différence constatée entre le passeport et la réalité sur le terrain.", en: "Never prevents this check from being recorded — only flags a difference noticed between the passport and reality on the ground.", es: "Nunca impide el registro de este control — solo señala una diferencia observada entre el pasaporte y la realidad sobre el terreno.", ar: "لا يمنع أبدًا تسجيل هذا الفحص — يقتصر على الإشارة إلى فرق لوحظ بين جواز السفر والواقع في الميدان." },
  "controle.signalement_aucun": { fr: "Aucune irrégularité à signaler", en: "No irregularity to report", es: "Ninguna irregularidad que señalar", ar: "لا توجد مخالفة للإبلاغ عنها" },
  "controle.signalement_details_placeholder": { fr: "Précisions (nombre réel constaté, description du cas...)", en: "Details (actual number observed, description of the case...)", es: "Precisiones (número real observado, descripción del caso...)", ar: "تفاصيل (العدد الفعلي المُلاحظ، وصف الحالة...)" },
  ...
  "impression.nb_commandes_fusionnees": { fr: "{n} commande(s) fusionnée(s) pour ce pays", en: "{n} order(s) merged for this country", es: "{n} pedido(s) fusionado(s) para este país", ar: "تم دمج {n} طلب(ات) لهذا البلد" },
  ...
  "impression.confirmer_intro": { fr: "Une fois ces {n} passeport(s) réellement imprimés, confirmez pour qu'ils ne réapparaissent plus.", en: "Once these {n} passport(s) are actually printed, confirm so they no longer reappear.", es: "Una vez que estos {n} pasaporte(s) estén realmente impresos, confirme para que no vuelvan a aparecer.", ar: "بمجرد طباعة هذه الـ {n} جواز (جوازات) فعليًا، أكّد حتى لا تظهر مجددًا." },
  "impression.confirmer_lot": { fr: "Confirmer l'impression de ce lot", en: "Confirm this batch as printed", es: "Confirmar la impresión de este lote", ar: "تأكيد طباعة هذه الدفعة" },
  "impression.confirmation_echouee": { fr: "La confirmation a échoué — le lot a peut-être changé, rechargez la page.", en: "Confirmation failed — the batch may have changed, reload the page.", es: "La confirmación falló — el lote pudo haber cambiado, recargue la página.", ar: "فشل التأكيد — ربما تغيرت الدفعة، أعد تحميل الصفحة." },
  ...
  "statistiques.parcours_titre": { fr: "Passeports par étape du parcours — de l'attribution au contrôle", en: "Passports by pipeline stage — from allocation to control", es: "Pasaportes por etapa del recorrido — de la asignación al control", ar: "جوازات السفر حسب مرحلة المسار — من التخصيص إلى المراقبة" },
  "statistiques.parcours_pays_indisponible": { fr: "Détail par pays indisponible pour le moment — affichage de la vue globale.", en: "Per-country detail unavailable right now — showing the global view.", es: "Detalle por país no disponible por el momento — se muestra la vista global.", ar: "التفاصيل حسب البلد غير متاحة حاليًا — يتم عرض الرؤية الإجمالية." },
  ...
  "statistiques.carte_ecart_geo": { fr: "{n} contrôle(s) sur {total} n'ont pas de position GPS enregistrée et n'apparaissent donc pas ci-dessous (permission de localisation non accordée au moment du contrôle).", en: "{n} check(s) out of {total} have no recorded GPS position and are therefore not shown below (location permission not granted at the time of the check).", es: "{n} control(es) de {total} no tienen posición GPS registrada y por lo tanto no aparecen abajo (permiso de ubicación no concedido en el momento del control).", ar: "{n} من أصل {total} مراقبة لا تملك موقعًا جغرافيًا مسجَّلاً وبالتالي لا تظهر أدناه (لم يُمنح إذن تحديد الموقع وقت المراقبة)." },
  ...
  "statistiques.pays": { fr: "Pays", en: "Country", es: "País", ar: "البلد" },
  "statistiques.revoques_titre": { fr: "Passeports révoqués", en: "Revoked passports", es: "Pasaportes revocados", ar: "جوازات السفر الملغاة" },
  "statistiques.revoques_intro": { fr: "Documents retirés définitivement du circuit, regroupés par intervalle de numéros consécutifs.", en: "Documents permanently withdrawn from circulation, grouped by consecutive number range.", es: "Documentos retirados definitivamente de circulación, agrupados por intervalo de números consecutivos.", ar: "وثائق سُحبت نهائيًا من التداول، مجمعة حسب نطاق أرقام متتالية." },
  "statistiques.revoques_aucun": { fr: "Aucun passeport révoqué pour ces filtres.", en: "No revoked passports for these filters.", es: "Ningún pasaporte revocado para estos filtros.", ar: "لا توجد جوازات سفر ملغاة لهذه المرشحات." },
  "statistiques.revoques_intervalle": { fr: "Intervalle", en: "Range", es: "Intervalo", ar: "النطاق" },
  "statistiques.revoques_nombre": { fr: "Nombre", en: "Count", es: "Cantidad", ar: "العدد" },
  "statistiques.revoques_motif": { fr: "Motif", en: "Reason", es: "Motivo", ar: "السبب" },
  "statistiques.revoques_a": { fr: "à", en: "to", es: "a", ar: "إلى" },
  "statistiques.revoques_dans_emissions": { fr: "{n} passeport(s) révoqué(s), exclu(s) de la liste ci-dessus", en: "{n} revoked passport(s), excluded from the list above", es: "{n} pasaporte(s) revocado(s), excluido(s) de la lista anterior", ar: "{n} جواز سفر ملغى، مستبعد من القائمة أعلاه" },
  "statistiques.revoques_voir_tout": { fr: "Tout afficher", en: "Show all", es: "Mostrar todo", ar: "عرض الكل" },
  "statistiques.revoques_voir_moins": { fr: "Afficher moins", en: "Show less", es: "Mostrar menos", ar: "عرض أقل" },
  "statistiques.tous_postes": { fr: "Tous les postes", en: "All posts", es: "Todos los puestos", ar: "جميع المراكز" },
  "statistiques.annee": { fr: "Année", en: "Year", es: "Año", ar: "السنة" },
  "statistiques.province": { fr: "Province d'origine", en: "Province of origin", es: "Provincia de origen", ar: "مقاطعة المنشأ" },
  "statistiques.province_placeholder": { fr: "Ex. Extrême-Nord", en: "E.g. Far North", es: "Ej. Extremo Norte", ar: "مثال: أقصى الشمال" },
  "statistiques.localite": { fr: "Localité d'origine", en: "Locality of origin", es: "Localidad de origen", ar: "بلدة المنشأ" },
  "statistiques.localite_placeholder": { fr: "Ex. Kousséri", en: "E.g. Kousséri", es: "Ej. Kousséri", ar: "مثال: كوسيري" },
  "statistiques.recherche_personne": { fr: "Recherche (nom ou CNI)", en: "Search (name or ID)", es: "Búsqueda (nombre o cédula)", ar: "بحث (الاسم أو رقم الهوية)" },
  "statistiques.recherche_placeholder": { fr: "Nom ou numéro de pièce d'identité", en: "Name or ID number", es: "Nombre o número de identificación", ar: "الاسم أو رقم بطاقة الهوية" },
  "statistiques.numero_passeport": { fr: "N° de passeport", en: "Passport no.", es: "N.º de pasaporte", ar: "رقم جواز السفر" },
  "statistiques.agent": { fr: "Agent", en: "Agent", es: "Agente", ar: "الوكيل" },
  "statistiques.tous_agents": { fr: "Tous les agents", en: "All agents", es: "Todos los agentes", ar: "جميع الوكلاء" },
  "statistiques.signalements_titre": { fr: "Signalements d'incident", en: "Incident reports", es: "Reportes de incidentes", ar: "تقارير الحوادث" },
  "statistiques.signalements_intro": { fr: "Irrégularités remontées par les agents de contrôle sur le terrain — permet de repérer un agent d'émission revenant anormalement souvent.", en: "Irregularities reported by control agents on the ground — helps spot an issuing agent coming up unusually often.", es: "Irregularidades señaladas por los agentes de control sobre el terreno — permite detectar un agente de emisión que aparece con inusual frecuencia.", ar: "مخالفات أبلغ عنها أعوان المراقبة في الميدان — تتيح رصد وكيل إصدار يتكرر ظهوره بشكل غير عادي." },
  "statistiques.signalements_tous_types": { fr: "Tous les types d'incident", en: "All incident types", es: "Todos los tipos de incidente", ar: "جميع أنواع الحوادث" },
  "statistiques.signalements_aucun": { fr: "Aucun signalement pour ces filtres.", en: "No reports for these filters.", es: "Ningún reporte para estos filtros.", ar: "لا توجد تقارير لهذه المرشحات." },
  "statistiques.signalements_classement_titre": { fr: "Agents d'émission les plus signalés", en: "Most reported issuing agents", es: "Agentes de emisión más señalados", ar: "وكلاء الإصدار الأكثر الإبلاغ عنهم" },
  "statistiques.signalements_nombre": { fr: "Nombre de signalements", en: "Number of reports", es: "Número de reportes", ar: "عدد التقارير" },
  "statistiques.signalements_sans_agent": { fr: "{n} signalement(s) sans agent d'émission identifiable (passeport jamais synchronisé ou antérieur au suivi).", en: "{n} report(s) with no identifiable issuing agent (passport never synced, or predating this tracking).", es: "{n} reporte(s) sin agente de emisión identificable (pasaporte nunca sincronizado, o anterior a este seguimiento).", ar: "{n} تقرير (تقارير) بدون وكيل إصدار قابل للتحديد (جواز سفر لم تتم مزامنته أبدًا، أو سابق لهذا التتبع)." },
  "statistiques.signalements_detail_titre": { fr: "Détail des signalements", en: "Report details", es: "Detalle de los reportes", ar: "تفاصيل التقارير" },
  "statistiques.signalements_type": { fr: "Type d'incident", en: "Incident type", es: "Tipo de incidente", ar: "نوع الحادثة" },
  "statistiques.signalements_poste_controle": { fr: "Poste de contrôle", en: "Control post", es: "Puesto de control", ar: "مركز المراقبة" },
  "statistiques.signalements_details": { fr: "Précisions", en: "Details", es: "Precisiones", ar: "تفاصيل" },
  "statistiques.signalements_agent_inconnu": { fr: "Inconnu", en: "Unknown", es: "Desconocido", ar: "غير معروف" },
  "statistiques.revocation_echouee": { fr: "La révocation a échoué — réessayez.", en: "Revocation failed — try again.", es: "La revocación falló — vuelva a intentarlo.", ar: "فشل الإلغاء — أعد المحاولة." },
  "statistiques.revoque_badge": { fr: "Révoqué", en: "Revoked", es: "Revocado", ar: "ملغى" },
  "statistiques.revoquer_selection": { fr: "Révoquer ({n})", en: "Revoke ({n})", es: "Revocar ({n})", ar: "إلغاء ({n})" },
  "statistiques.revoquer_confirmation_titre": { fr: "Retirer {n} passeport(s) du circuit ?", en: "Remove {n} passport(s) from circulation?", es: "¿Retirar {n} pasaporte(s) de circulación?", ar: "سحب {n} جواز سفر من التداول؟" },
  "statistiques.revoquer_confirmation_aide": { fr: "Ces passeports seront systématiquement refusés à tout contrôle ultérieur, même si leur signature reste techniquement valide. Aucun moyen d'annuler cette action n'existe actuellement dans la plateforme.", en: "These passports will be systematically refused at any future check, even if their signature remains technically valid. There is currently no way to undo this action within the platform.", es: "Estos pasaportes serán rechazados sistemáticamente en cualquier control posterior, incluso si su firma sigue siendo técnicamente válida. Actualmente no existe ninguna forma de deshacer esta acción en la plataforma.", ar: "سيتم رفض جوازات السفر هذه بشكل منهجي في أي مراقبة لاحقة، حتى لو ظل توقيعها صالحًا تقنيًا. لا توجد حاليًا طريقة للتراجع عن هذا الإجراء داخل المنصة." },
  "statistiques.revoquer_motif_placeholder": { fr: "Motif de la révocation (obligatoire)", en: "Reason for revocation (required)", es: "Motivo de la revocación (obligatorio)", ar: "سبب الإلغاء (إلزامي)" },
  "statistiques.revoquer_confirmer": { fr: "Confirmer la révocation", en: "Confirm revocation", es: "Confirmar la revocación", ar: "تأكيد الإلغاء" },
  "statistiques.revoquer_ce_passeport": { fr: "Révoquer seulement ce passeport", en: "Revoke only this passport", es: "Revocar solo este pasaporte", ar: "إلغاء هذا الجواز فقط" },
  "statistiques.revoquer_toute_commande": { fr: "Révoquer toute la commande", en: "Revoke the whole order", es: "Revocar todo el pedido", ar: "إلغاء الطلب بأكمله" },
  ...
  "statistiques.etape": { fr: "Étape", en: "Stage", es: "Etapa", ar: "المرحلة" },
  "statistiques.statut": { fr: "Statut", en: "Status", es: "Estado", ar: "الحالة" },
  "statistiques.exporter_pdf": { fr: "Exporter en PDF", en: "Export as PDF", es: "Exportar a PDF", ar: "التصدير إلى PDF" },
  "statistiques.exporter_excel_titre": { fr: "Exporter en Excel", en: "Export as Excel", es: "Exportar a Excel", ar: "التصدير إلى Excel" },
