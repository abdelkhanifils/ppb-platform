...
const DICO: Record<string, Entree> = {
  ...
  "statistiques.historique_personne_intro": { fr: "Historique de tous les passeports où cette personne est apparue", en: "History of all passports this person has appeared on" },
  "statistiques.aucun_voyage": { fr: "Aucun autre passeport trouvé pour cette personne.", en: "No other passport found for this person." },
  "statistiques.controles_effectues": { fr: "Contrôles effectués", en: "Checks performed" },
  "statistiques.aucun_controle": { fr: "Aucun contrôle enregistré pour ce passeport.", en: "No check recorded for this passport." },
